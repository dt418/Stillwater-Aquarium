...
export function createPlants(scene, {
  ...
  animatedShadows = true, castShadows = true, distanceLod = false, simpleMaterials = false,
} = {}) {
  ...
  const mesh = new THREE.Mesh(batch.geometry(), foliageMaterial({ simple: simpleMaterials }));
